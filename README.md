...
```sbt
  libraryDependencies += "de.megaera" %% "medeia" % "0.12.2"
```
...
```sbt
  libraryDependencies += "de.megaera" %% "medeia-enumeratum" % "0.12.2"
```
...
```sbt
  libraryDependencies += "de.megaera" %% "medeia-refined" % "0.12.2"
```
