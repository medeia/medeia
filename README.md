...
```sbt
  libraryDependencies += "de.megaera" %% "medeia" % "0.13.0"
```
...
```sbt
  libraryDependencies += "de.megaera" %% "medeia-enumeratum" % "0.13.0"
```
...
```sbt
  libraryDependencies += "de.megaera" %% "medeia-refined" % "0.13.0"
```
